...
class BigAlan : public Component {
  public:
    ...
    explicit BigAlan(GameObject &associated) : Component(associated) {
        // each constant is associated with an image to 
    ...
    // method that will be called to update the character
  ...
  private:
  // Variables combos that will make the calculations to define the animation of the character
